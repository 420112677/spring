                ...
                <ul class="hypz gjpz clearfix">
                  <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" name="oldPassword" type="text">
                            <i>*</i>
                        </div>
                    </li>
                     <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" id="new" name="newPassword" type="text">
                            <i>*</i>
                        </div>
                    </li>
                     <li class="clearfix">
                        <span class="title">新密码确认：</span>
                        <div class="li_r">
                            <input class="chang" id="check" type="text">
                            <i>*</i>
                        </div>
                    </li>
